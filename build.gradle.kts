...
subprojects {
    ...
    extra.apply {
        ...
        set("jacksonVersion", "2.20.0")         // https://mvnrepository.com/artifact/com.fasterxml.jackson.core/jackson-annotations
        ...
        set("kotlinVersion", "2.2.10")          // https://mvnrepository.com/artifact/org.jetbrains.kotlin/kotlin-stdlib-common
